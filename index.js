...
const JWT_SECRET = "16bbfc523c989c841316a9cc0566f8da4f42519884a35818791440474b453f8e";
...
app.post('/uploadWrites',async (req,res) =>{
    await writesModel.create(req.body)
    .then(res.send({staus : 200}))
    .catch(err => console.log(err))
})
...
app.get('/getWrites/:type',(req,res) => {
    writesModel.find({type:req.params.type})
    .then(data => res.send({status: 200, data: data}))
    .catch(err => console.log(err))
})
